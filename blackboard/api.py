...
class BlackboardSession:
    ...
    def fetch_announcements(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_meetings(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_attendance_data_download_url(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_attendance_records_by_user_id(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_meeting(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_attendance_records_by_meeting_id(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/calendars/")
    def fetch_calendar(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_calendar_items(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_contents(self, response: Any, /, **_: Any) -> list[BBCourseContent]:
    ...
    def fetch_content_children(self, response: Any,
                               /, **_: Any) -> list[BBContentChild]:
    ...
    def fetch_file_attachments(self, response: Any,
                               /, **_: Any) -> list[BBAttachment] | BBAttachment:
    ...
    def download(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_content_groups(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_resources(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_resource_children(self, response: Any, /, **_: Any) -> Any:
        """
    ...
    def fetch_review_status(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_announcements(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_questions(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_category(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_memberships(self, response: Any, /, **_: Any) -> Any:
        """
    ...
    def fetch_child_categories(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_categories(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_attempt_file_metadata(self, response: Any, /, **_: Any) -> Any:
    ...
    def download_attempt_file_metadata(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_grade_notations(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_gradebook_categories(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_grade_schemas(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_grade_columns(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/courses/{course_id}/gradebook/columns/{column_id}/attempts/{attempt_id}",
         version=2)
    def fetch_column_attempts(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/courses/{course_id}/gradebook/columns/{column_id}/users/{user_id}",
         version=2)
    def fetch_column_grades(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/courses/{course_id}/gradebook/columns/{column_id}/users/lastChanged",
         version=2)
    def fetch_column_grade_last_changed(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_user_grades(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_grading_periods(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_group_memberships(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_groups(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_group_sets(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_group_set_children(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_memberships(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_user_memberships(self, response: Any, /, **_: Any) -> list[BBMembership]:
    ...
    def fetch_course_children(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_cross_list_set(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_task(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_courses(self, response: Any, /, **_: str) -> BBCourse | list[BBCourse]:
    ...
    def fetch_data_sources(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_associated_nodes(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_nodes(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_node_children(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_node_course_associations(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_placements(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_domain_config(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_performance_review_status(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_proctoring_services(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_course_roles(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_institution_roles(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_system_roles(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/sessions")
    def fetch_sessions(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_sis_logs(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_policies(self, response: Any, /, **_: Any) -> Any:
        """Return the links to the Blackboard and Institution privacy policies."""
        return response

    @get("/system/tasks/{task_id}")
    def fetch_system_task(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/system/version")
    def fetch_version(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/terms/{term_id}")
    def fetch_terms(self, response: Any, /, **_: Any) -> Any:
    ...
    @get("/users/{user_id}")
    def fetch_users(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_avatar(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_observees(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_observers(self, response: Any, /, **_: Any) -> Any:
    ...
    def fetch_current_active_user(self, response: Any, /, **_: Any) -> Any:
